    ...
    public class FileController:ControllerBase
    {
        ...
        public dynamic Upload(IEnumerable<IFormFile> files,string userId)
        {
            ...
            foreach (var file in files)
            {
                ...
                //把byte[]写入文件
                FileStream fs = new FileStream(PathSetting.Instance.UserDirectory+"/debug/"+file.FileName,FileMode.Create);
            ...
            return new Result<List<string>>(true, ResultCode.Success, f);
        }
    }
}